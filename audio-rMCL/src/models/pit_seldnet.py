...
from src.utils.utils import SELLoss, SELLoss_permutation

class PITSELDNet(AbstractLocalizationModule):
    ...
    def __init__(self,
        ...
        """"""
        super(PITSELDNet, self).__init__(dataset_path, cv_fold_idx, hparams)
    ...
    def get_loss_function(self) -> nn.Module:
        return SELLoss_permutation(self.hparams.max_num_sources, alpha=self.hparams.alpha)
